...
export const createPenerima = async (
    ...
    try {
        const { nama_instansi, kategori, nomor_whatsapp, alamat, latitude, longitude, user_id } = req.body;
        const newPenerima = await db
            .insert(penerimaTable)
            .values({ nama_instansi, kategori, nomor_whatsapp, alamat, latitude, longitude, user_id })
            .returning();
...
export const updatePenerima = async (
  ...
  res: Response,
    ...
    try {
        ...
        const { nama_instansi, kategori, nomor_whatsapp, alamat, latitude, longitude } = req.body;
        const data: any = {};
